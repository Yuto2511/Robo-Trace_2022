...
int start_stop()
{
	if(HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_2) == 0) side_r_flag = 1;
	else if(HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_2) != 0) side_r_flag = 0;

	if(HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_3) == 0) side_l_flag = 1;
	else if(HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_2) != 0) side_l_flag = 0;
